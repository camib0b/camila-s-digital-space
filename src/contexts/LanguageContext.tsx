...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "experience.job4.title": "Data Analytics Intern",
    "experience.job4.company": "ACFIN",
    "experience.job4.period": "Feb 2026 – Present",
    "experience.job4.description": "Ship investor-facing Looker dashboards for structured credit portfolios; SQL-heavy reporting and investor analytics.",
    ...
    "experience.job1.description": "Shipped reactive views with reusable components in TypeScript + Vue.js.",
    "experience.job2.title": "Hotel Asset Management Intern",
    "experience.job2.company": "A3 Property Investments",
    "experience.job2.period": "Summer 2023",
    "experience.job2.description": "KPI reporting for board of directors.",
    ...
    "cv.job4.title": "Data Analytics Intern",
    "cv.job4.company": "ACFIN",
    "cv.job4.period": "Feb 2026 – Present",
    "cv.job4.bullet1": "Build and maintain Looker/LookML dashboards and explores that deliver structured-credit portfolio analytics to investors.",
    "cv.job4.bullet2": "Author and optimize SQL for reporting metrics, explores, and data checks underpinning investor-facing BI.",
    "cv.job4.bullet3": "Develop domain depth in structured credit, corporate finance, and issuer business models to translate stakeholder questions into reliable analytics.",
  ...
  es: {
    ...
    "experience.job4.title": "Pasante en Análisis de Datos",
    "experience.job4.company": "ACFIN",
    "experience.job4.period": "Feb 2026 – Actualidad",
    "experience.job4.description": "Dashboards en Looker para portafolios de crédito estructurado orientados a inversionistas; reporting y analítica con SQL.",
    ...
    "experience.job2.title": "Práctica en Gestión de Activos Hoteleros",
    "experience.job2.company": "A3 Property Investments",
    "experience.job2.period": "Verano 2023",
    "experience.job2.description": "Generación de reportes de KPI para presentaciones del directorio.",
    ...
    "cv.job4.title": "Pasante en Análisis de Datos",
    "cv.job4.company": "ACFIN",
    "cv.job4.period": "Feb 2026 – Actualidad",
    "cv.job4.bullet1": "Construyo y mantengo dashboards y explores en Looker/LookML con analítica de portafolios de crédito estructurado para inversionistas.",
    "cv.job4.bullet2": "Escribo y optimizo SQL para métricas de reporting, explores y validaciones de datos que sustentan BI orientado a inversionistas.",
    "cv.job4.bullet3": "Profundizo en crédito estructurado, finanzas corporativas y modelos de negocio de emisores para traducir preguntas de negocio en analítica confiable.",
