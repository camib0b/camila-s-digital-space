...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "hero.note1": "Web dev is so much more than front end.",
    "hero.note2": "Don't bother children when skateboarding.",
  ...
  es: {
    ...
    "hero.note1": "El desarrollo web es mucho más que frontend.",
    "hero.note2": "No molestes a los niños mientras estén patinando.",
  ...
  fr: {
    ...
    "hero.note1": "Le développement web est bien plus que le frontend.",
    "hero.note2": "Dont bother children when skateboarding.",
