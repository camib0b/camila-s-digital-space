...
const es: Record<TranslationKey, string> = {
    ...
    "cv.finapsys.bullet1": "Construí vistas reactivas con componentes reutilizables en TypeScript y Vue.js.",
    "cv.finapsys.bullet2": "Trabajé en el frontend de un producto SaaS B2B de health tech.",
    "cv.a3.title": "Práctica en Gestión de Activos Hoteleros",
    "cv.a3.company": "A3 Property Investments",
    "cv.a3.period": "Verano 2023",
    "cv.a3.bullet1": "Preparé reportes de KPI para el directorio.",
